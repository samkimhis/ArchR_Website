...
This is a ___brief___ ArchR tutorial. It does not showcase all of ArchR's functionality nor explain each of the steps in detail. Please see [the searchable full user's manual](https://www.archrproject.com/bookdown/index.html) for an in-depth tutorial using real-world data and a full description of all aspects of ArchR analysis. __Importantly, this tutorial and the full user manual assume that you are running ArchR locally__.
